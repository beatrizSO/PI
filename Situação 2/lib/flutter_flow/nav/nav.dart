...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => _RouteErrorBuilder(
        state: state,
        child: appStateNotifier.loggedIn ? const HomeAdminWidget() : const LoginWidget(),
      ),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) =>
              appStateNotifier.loggedIn ? const HomeAdminWidget() : const LoginWidget(),
          routes: [
            FFRoute(
              name: 'ForgotPassword',
              path: 'forgotPassword',
            ...
            FFRoute(
              ...
              path: 'ordersCopy',
              requireAuth: true,
              builder: (context, params) => const OrdersCopyWidget(),
            ),
            FFRoute(
              name: 'CartCopy',
              path: 'cartCopy',
