                  ...
                  builder: (context, snapshot) {
                    ...
                    return FFButtonWidget(
                      onPressed: () async {
                        ...
                        await OrderedProductRecord.createDoc(
                                currentUserReference!)
                            .set({
                          ...createOrderedProductRecordData(
                            ...
                            orderValue: functions.listSum(_model.orderedProduct!
                                .map((e) => e.finalPrice)
                                .toList()),
                            userAddress: currentUserReference,
                            userName: currentUserReference,
                            userRef: currentUserReference,
                          ),
                          ...mapToFirestore(
                            {
                              'Products': _model.orderedProduct
                                  ?.map((e) => e.productRef)
                                  .withoutNulls
                                  .toList(),
                            },
